...
import 'package:best_flutter_ui_templates/design_course/search_text_field_widget.dart';
import 'package:best_flutter_ui_templates/design_course/models/search_result_entity.dart';
...
class SearchPage extends StatefulWidget {
  ...
  ///搜索框中的默认显示内容
  SearchPage({Key key, this.searchHintContent = 'what do your want?'})
      : super(key: key);
