...
Widget addBtn(context,setState,imgData,imgPicked){
  return GestureDetector(
    ...
    onTap: (){
      ...
      //点击添加按钮
      JhBottomSheet.showText(context, dataArr: ["拍照","相册","相册","相册","相册","相册","相册","相册","相册","相册","相册"],title: "请选择",
          clickCallback: (index,str) async{
            if(index==0){
              final picker = ImagePicker();
              var image = await picker.getImage(source: ImageSource.camera,maxWidth: 800,
                  maxHeight: 800,
                  imageQuality: 100);
              print(image);
...
//                child:Image.file(imgData[index], fit: BoxFit.cover),
              ...
              GestureDetector(
                child: Image(image: JhImageUtils.getAssetImage("selectPhoto_close"),width: deleBtnWH,height: deleBtnWH,),
                onTap: (){
                  //点击删除按钮
                  setState(() {
